...
public class Localizer : Singleton<Localizer>
{
	...
	public void UpdateData() {
		mLocalizedSpritePath = "Sprites/Localized/" + Singleton<GameVersion>.instance.language + "/";
		mLocalizedFontPath = "Fonts/" + Singleton<GameVersion>.instance.fontSet + "/";
		Singleton<FontSetFinder>.instance.Reset();
		mData = null;
		CacheData();
	}
}
