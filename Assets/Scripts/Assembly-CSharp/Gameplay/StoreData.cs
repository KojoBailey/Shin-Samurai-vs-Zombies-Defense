...
public class StoreData {
	public class Item {
		...
		// Details shown when clicking on store item.
	...
	public class Details {
		...
		public void Render(SUILayout layout, bool locked, bool isNotEnoughDialog = false) {
			...
			// If locked, don't display any stats.
			if (locked) return;
